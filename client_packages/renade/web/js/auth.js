...
let handleLogin = () => {
    mp.trigger('loginPlayer', $('#loginLoginInput').val(), $('#passwordLoginInput').val(), $('#remember').is(":checked"));
}

let loginOrRegisterSuccess = (playerLogin, charFirstName, charFamilyName, charLvl) => {
    ...
    $('#firstCharacter').html(charFirstName + " " + charFamilyName + ", " + charLvl + " lvl");
    mainPages.hide();
    slotsPage.show();
}
...
$(document).ready(() => {
    ...
    mainPages = $('.login-page, .reg-page, .slots-page, .spawn-page, .offline-page');
